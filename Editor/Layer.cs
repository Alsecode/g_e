...
namespace Editor
{
    public class Layer
    {
        ...
        public List<Bitmap> undoList = new List<Bitmap>();
        public List<Bitmap> redoList = new List<Bitmap>();
        ...
        public void Undo()
        {
            ...
            redoList.Add(new Bitmap(bitmap));
            bitmap = undoList.Last();
